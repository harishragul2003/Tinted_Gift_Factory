            ...
            {!isLogin && (
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-gray-100 dark:bg-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all duration-300"
                />
              </div>
            )}
